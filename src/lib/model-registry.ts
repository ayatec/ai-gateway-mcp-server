...
const models: ModelDefinition[] = [
  ...
  },
  {
    ...
    note: 'GPT-5 Miniの上位版。推論・コーディング・ビジョンが大幅向上、400Kコンテキスト。検索品質はgpt-5-miniより簡潔で信頼性が高いがコストは約2倍',
  },
  {
    ...
    pricing: { input: 0.2, cachedInput: 0.02, output: 1.25 },
    searchCost: {
      type: 'token_based',
      description: '検索結果がinputトークンに含まれる（膨張大）',
    },
    maxOutputTokens: 128000,
    releasedAt: '2026-03-17',
    note: 'GPT-5 Nanoの上位版。Web検索対応でGPT-5 Miniより安い（$1.45 vs $2.25/1M）、コーディングも向上。検索品質はgpt-5-miniとほぼ同等で簡単な検索に最適',
  },
  {
